...
const c: TourCase = {
  ...
  outcome: "One click turned an evidence-backed suggestion into a draft rule she can test, still switched off until someone activates it.",
  start: "intent",
  poster: 5,
  steps: [
    {
      ...
      body: "Maya is in Intent Studio, where the company's rules live. She opens Policy Autopilot: rules Wrapbox suggests from what agents actually did.",
    ...
    },
    {
      ...
      body: "Over 30 days, 93% of coding-agent pushes went to side branches. Every forced push to main, which can overwrite the primary copy of the code, was reviewed or refused.",
    },
    {
    ...
    },
    {
      ...
      body: "Back on the company's rules, the count went from 5 to 6. The new card carries Priya's name: this demo records new rules under its admin, Priya.",
    ...
    },
    {
      ...
      body: "It is marked DRAFT, so no agent is affected yet. ENFORCED means Wrapbox's GitHub connection can already check these pushes, so the rule works the moment it's switched on.",
    },
    {
      target: { selector: ".ecard", text: "Autopilot · Protect main branch" },
      action: "click",
      title: "Open the new rule",
      body: "Maya opens the draft to see exactly what it checks. Nothing changes until someone presses Activate.",
      waitFor: { within: ".drawer", selector: ".card", text: "Only in" },
    },
    {
      target: { within: ".drawer", selector: ".card", text: "Only in" },
      title: "Read the rule in plain terms",
      body: "REVIEW: a person must approve before the push goes ahead. Pushes to main count as production changes. \"Fail closed\": a push Wrapbox can't inspect is blocked, not waved through.",
    },
  ],
};
export default c;
