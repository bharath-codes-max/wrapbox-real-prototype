...
import { PageHead, SectionHead, MetricBar, Chip, SimNote, AgentMark, Avatar, DecisionChip } from "../ui/kit";
  ...
  return (
    <div className="page">
      ...
      <div className="section">
        <SectionHead title="Permissions" sub="Every standing permission — who holds it, what it allows, what it never allows, and what would change if you revoked it" />
        {s.standing.length === 0 && (
