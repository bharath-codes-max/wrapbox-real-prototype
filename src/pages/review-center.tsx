...
import { PageHead, SectionHead, MetricBar, DecisionChip, Chip, RiskChip, SimNote, names, timeAgo, StatusChip, Avatar, AgentMark, DestMark } from "../ui/kit";
  ...
  return (
    <div className="page">
      ...
      {/* Lead with the inbox — the work that needs a human. Counts live in the
          section header, not in a row of oversized number boxes. */}
